...
if [[ ! -z ${PARAMSTESTKUBE_PARAMS_ENVIRONMENT} ]]; then
  ...
  export SAMPLE_MEMORY=$IMGOPTSSAMPLEKUBETEST_MEMORY
  export SAMPLE_CPU=$IMGOPTSSAMPLEKUBETEST_CPUSHARES
  export SAMPLE_IMAGE_URL=$IMGSAMPLEKUBE_SOURCENAME
  export SAMPLE_IMAGE_TAG=$IMGSAMPLEKUBE_VERSIONNAME
  export SAMPLE_REPLICAS=$REPLICASSAMPLEKUBETEST_COUNT
  ...
  export NGINX_IMAGE_TAG=$IMGNGINX_VERSIONNAME
    ...
    export SAMPLE_MEMORY=$IMGOPTSSAMPLEKUBEPROD_VERSIONMEMORY
    export SAMPLE_CPU=$IMGOPTSSAMPLEKUBEPROD_VERSIONCPUSHARES
    export SAMPLE_REPLICAS=$REPLICASSAMPLEKUBEPROD_VERSIONCOUNT
