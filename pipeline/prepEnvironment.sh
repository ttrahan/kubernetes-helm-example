...
if [[ ! -z ${PARAMSKUBEHELMTEST_PARAMS_ENVIRONMENT} ]]; then
  echo "preparing TEST environment variables..."
  export ENVIRONMENT=$PARAMSKUBEHELMTEST_PARAMS_ENVIRONMENT
  export SAMPLE_IMAGE_URL=$IMGSAMPLEKUBEHELM_SOURCENAME
  export SAMPLE_IMAGE_TAG=$IMGSAMPLEKUBEHELM_VERSIONNAME
  export SAMPLE_PORT=$PARAMSSAMPLEKUBEHELMTEST_PARAMS_PORT
  ...
  export NGINX_IMAGE_TAG=$IMGNGINX_VERSIONNAME
  ...
  elif [[ ! -z ${PARAMSKUBEHELMPROD_PARAMS_ENVIRONMENT} ]]; then
    ...
    export ENVIRONMENT=$PARAMSKUBEHELMPROD_PARAMS_ENVIRONMENT
    export SAMPLE_IMAGE_URL=$SAMPLE_IMAGE_URL_PREVIOUS
    export SAMPLE_IMAGE_TAG=$SAMPLE_IMAGE_TAG_PREVIOUS
    export SAMPLE_PORT=$PARAMSSAMPLEKUBEHELMPROD_PARAMS_PORT
